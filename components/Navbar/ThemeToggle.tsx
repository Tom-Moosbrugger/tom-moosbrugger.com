...
const ThemeToggle = () => {
  ...
  return (
    <div
      onClick={toggleTheme}
      className="flex min-w-10 cursor-pointer justify-center"
    >
      <button
        className={`border-bracket flex min-h-7 min-w-8 cursor-pointer items-center justify-center rounded-full border-1 py-0.5 hover:bg-${
